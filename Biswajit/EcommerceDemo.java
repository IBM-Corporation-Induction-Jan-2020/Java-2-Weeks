...
public class EcommerceDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * Execute the program with 3 fixed eCommerce service providers & threir
		 * products. Ex: Amazon(Electronics: Laptop 20k 10q, Tablet 10k 20q, Mobile 5k
		 * 40q), FlipKart (Books: Traditions 1000 50q, Spiritual 500 100q, SciFi 250
		 * 200q), SnapDeal (Groceries: Rice 400 50q, Pulses 200 200q, Oils 125 500q)
		 */
		...
		HashMap<Long, EcommerceUser> hmUser = new HashMap<>();

		for (;;) {
			System.out.println("Choose 1/2/3/4 for Creation of User /Purchase Product/ Return Product/Reports/Exit");
			...
			case 1:
				...
				break;
			case 2:
				ops.purchase(hm, hmUser);
				break;
			case 3:
				ops.returnItem(hm, hmUser);
				break;
			case 4:
				ops.report(hm, hmUser);
				break;
			case 5:
				System.exit(0);
			default:
